...
if __name__ == "__main__":
    ...
    with cleanup():
        ...
        classifier_layers = [
            ...
            VectorLayer("LifeZone_C", os.path.join(layer_root, "inventory", "inventory.shp"), Attribute("LifeZone_C"), tags=[reporting_classifier_tag]),
            VectorLayer("Biome", os.path.join(layer_root, "inventory", "Biomes_Colombia_Project.shp"), Attribute("Biome"), tags=[reporting_classifier_tag]),
        ]
        ...
        layers = [
            ...
            RasterLayer(os.path.join(layer_root, "environment", "temperature.tif"), name="mean_annual_temperature"),
        ] + classifier_layers
